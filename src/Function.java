...
/**
 * Function ist ein Wrapper fuer einen mathematische Funktionsbeschreibung Ueber
 * diese Klassen kann eine als String gegebenen Funktion ausgewertet werden.
 */
public class Function extends Observable {
     ...
     * @throws IllegalArgumentException wird geworfen wenn der Funktionsausdruck
    ...
    /**
     * Setzt den Funktionsausdruck neu Wenn der neue Funktionsausdruck nicht
     * verarbeitet werden kann, wir das die Funktion nicht veraendert.
     *
     * @param formula muss ein gueltiger Funktionsausdruck sein
     * @throws IllegalArgumentException wird geworfen wenn der Funktionsausdruck
     * nicht verarbeitet werden kann
            ...
            if (currentExpression == null) {
                if (lastExpression == null || (lastExpression instanceof Operation && ((Operation) lastExpression).getRightExpression() == null)) {
                    ...
                    while (Character.isLetter(c)) {
                        position[0]++;
                        if (position[0] >= formula.length()) {
                            throw new IllegalArgumentException("Function without argument? Error at " + position[0]);
                        }
                        c = formula.charAt(position[0]);
                    }
                    ...
                    if (func.equalsIgnoreCase("sin")) {
                        function = new Func() {
                            public double calc(double x) {
                                return Math.sin(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.cos(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.tan(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.asin(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.acos(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.atan(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.exp(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.log(argument.calc(x));
                            }
                        ...
                        function = new Func() {
                            public double calc(double x) {
                                return Math.sqrt(argument.calc(x));
                            }
